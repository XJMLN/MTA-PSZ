	...
	if (t and isElement(t) and getElementDimension(t)==pd and getElementInterior(t)==pi) then
			...
			if dist < defdd then
				...
				if scx and scy and isLineOfSightClear ( px, py, pz, cx, cy, cz, true,false, true, true ) then
					...
					local ac=(r+g+b)/3
					dxDrawText ( text, scx+2, scy+2, scx, scy, tocolor ( 255-ac, 255-ac, 255-ac, alpha ), scale, "default-bold", "center", "center" )
					dxDrawText ( text, scx-2, scy+2, scx, scy, tocolor ( 255-ac, 255-ac, 255-ac, alpha ), scale, "default-bold", "center", "center" )
					dxDrawText ( text, scx+2, scy-2, scx, scy, tocolor ( 255-ac, 255-ac, 255-ac, alpha ), scale, "default-bold", "center", "center" )
					dxDrawText ( text, scx-2, scy-2, scx, scy, tocolor ( 255-ac, 255-ac, 255-ac, alpha ), scale, "default-bold", "center", "center" )
					dxDrawText ( text, scx, scy, scx, scy, tocolor ( r, g, b, alpha ), scale, "default-bold", "center", "center" )
				end
			end
	end
 end

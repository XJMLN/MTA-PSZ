local CHANGE_INTERVAL=180000
local klub=createColSphere(-1543.66,926.16,7.04,170)
local klub_lc=getTickCount()-CHANGE_INTERVAL
setElementInterior(klub, 0)
...
addEventHandler("doChangeAudio", resourceRoot, function(plr, strumien, opis)
	if getTickCount()-klub_lc<CHANGE_INTERVAL then
		outputChatBox("Zmiana muzyki jest możliwa co 3 minuty.", plr)
		return
	end
	...
	setElementData(klub,"audio", { strumien,-1543.66,926.16,7.04,0, 0, 45, 170} )
end)
--[[

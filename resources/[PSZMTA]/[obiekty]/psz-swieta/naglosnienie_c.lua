...
local function playNewAudio(audio)
	...
	playingAudio=playSound3D("http://s15038.rbx2.fastd.svpj.pl/psz-muzyka/swieta/"..audio[1],audio[2],audio[3],audio[4],true)
...
local radia={
	...
	{nazwa="Hallelujah - Pentatonix", url="hallelujah.mp3"},
	{nazwa="Królik hasa, raz po raz", url="mr_christmas_rmx.mp3"},
}

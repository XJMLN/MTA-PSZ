...
function setVehicleHandling ( vehicle, property, value, withLog )
   ...
   setElementData(vehicle,"vehicle:hedit",true)
	...
	local t
    if (not getElementData(client,'handling:history')) then
		local t = "Zmiana: ("..getElementModel(vehicle)..") ["..property.."] stare: "..oldValue.." - nowe "..value.." \n"
		setElementData(client,'handling:history',t)
	else 
		local t = getElementData(client,'handling:history') .. "Zmiana: ("..getElementModel(vehicle)..") ["..property.."] stare: "..oldValue.." - nowe "..value.." \n"
		setElementData(client,'handling:history',t)
	end
    return true
end

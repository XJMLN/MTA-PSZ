...
float4 PixelShaderFunctionSM3(PSInput PS) : COLOR0
{
    ...
    float waterMask = tex2D(SamplerMask, TexProj.xy).a;
...
technique dxDrawImage4D_ref_PS3_DB_MRT
{
  pass P0
  {
    ZEnable = false;
...
technique dxDrawImage4D_ref_PS3_noDB_MRT
{
  pass P0
  {
    ZEnable = true;
...
technique dxDrawImage4D_ref_PS2_noDB_MRT
{
  pass P0
  {
    ZEnable = true;

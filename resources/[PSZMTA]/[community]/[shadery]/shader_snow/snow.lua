...
local snowRemoveList = {
						"",												-- unnamed
						"bobobillboard1","ads003 copy","bobo_2","bobo_3",
						"cj_sprunk_front2","cokopops_2","didersachs01",
						"eris_1","eris_2","eris_3","eris_4","eris_5",
						"hardon_1","heat_01","heat_02","homies_1_128",
						"homies_1","homies_2","heat_04","prolaps01",
						"prolaps01_small","prolaps02","semi1dirty",
						"semi3dirty","sunbillb03","sunbillb10","ws_suburbansign",
						"victim_bboard",
...
function startSnow()
	--if (not getElementData(getLocalPlayer(),"snow")) then return end
	if not snowing then
		snowflakes = {}
		
		snowShader = dxCreateShader ( "fx/snow_ground.fx", 0, maxEffectDistance )
		treeShader = dxCreateShader( "fx/snow_trees.fx" )
		naughtyTreeShader = dxCreateShader( "fx/snow_naughty_trees.fx" )
		sNoiseTexture = dxCreateTexture( "fx/smallnoise3d.dds" )
